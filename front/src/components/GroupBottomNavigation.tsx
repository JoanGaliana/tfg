...
export default function GroupBottomNavigation({
  active,
  groupId,
}: GroupBottomNavigationArgs) {
  ...
  return (
    <Paper
      ...
      elevation={3}
    >
      <BottomNavigation showLabels value={activeIndex[active]}>
        <BottomNavigationAction
          label="Gastos"
          icon={<AccountsBalanceIcon />}
          onClick={() => navigateToSubpath("")}
        />
        <BottomNavigationAction
          label="Miembros"
          icon={<PeopleIcon />}
          onClick={() => navigateToSubpath("members")}
        />
        <BottomNavigationAction
          label="Configuración"
          icon={
